...
import 'package:family_tree/bloc/movies_bloc/movies_bloc.dart';
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      child: ListTile(
                        onTap: () {
                          Timer(const Duration(seconds: 2), () => Navigator.pushNamed(context, RoutesName.tree, arguments: tvShow));
                        },
